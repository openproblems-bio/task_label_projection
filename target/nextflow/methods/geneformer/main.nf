  ...
  "engines" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "GIT_LFS_SKIP_SMUDGE=1 git clone --depth=1 https://huggingface.co/ctheodoris/Geneformer /tmp/Geneformer && pip install /tmp/Geneformer && rm -rf /tmp/Geneformer"
          ]
        }
      ]
    }
