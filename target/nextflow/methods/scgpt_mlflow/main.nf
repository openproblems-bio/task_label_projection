...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--model",
          "description" : "An MLflow model URI for the scGPT model. If it is a .zip or\n.tar.gz file it will be extracted to a temporary directory.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
          "direction" : "input",
  ...
  "label" : "scGPT (MLflow)",
  "summary" : "scGPT is a foundation model for single-cell biology (MLflow model)",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_label_projection/task_label_projection/src/methods/scgpt_mlflow/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_label_projection/methods/scgpt_mlflow",
