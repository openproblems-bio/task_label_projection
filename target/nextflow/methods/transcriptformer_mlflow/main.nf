...
meta = [
  ...
  "label" : "TranscriptFormer (MLflow)",
  "summary" : "Context-aware representations of single-cell transcriptomes (MLflow model)",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_label_projection/task_label_projection/src/methods/transcriptformer_mlflow/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_label_projection/methods/transcriptformer_mlflow",
