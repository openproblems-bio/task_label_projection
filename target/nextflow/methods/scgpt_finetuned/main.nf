  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "integer",
          "name" : "--batch_size",
          "description" : "Batch size for training and inference.",
          "info" : {
            "test_default" : 4
          },
          "example" : [
      ...
      "setup" : [
        {
          "type" : "docker",
          "run" : [
            "git clone https://github.com/bowang-lab/scGPT && pip install gdown && cd scGPT && pip install -e ."
          ]
        }
      ]
    }
