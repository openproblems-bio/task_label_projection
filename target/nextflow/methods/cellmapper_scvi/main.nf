...
meta = [
  ...
  "summary" : "Label projection in an scVI-latent space using CellMapper",
  "description" : "CellMapper is a general framework for k-NN based mapping tasks in single-cell and spatial genomics.\nThis variant uses CellMapper to project labels from a reference dataset onto a query dataset in an scVI latent space.\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_label_projection/task_label_projection/src/methods/cellmapper_scvi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/cellmapper_scvi",
    "viash_version" : "0.9.7",
    "git_commit" : "e14ce24c4af90c1f7311a52db4f9e720d97cc91e",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_label_projection/methods/cellmapper_scvi",
    "tag" : "2.1.0-rc1"
  },
  "label" : [
    "midtime",
