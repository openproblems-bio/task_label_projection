      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--paramsets",
          "description" : "A yaml file mapping method ids to named parameter sets, e.g.:\n\n  scprint:\n    large:\n      model_name: large-v1\n    small:\n      model_name: small-v1\n\nEach listed method is run once per parameter set, with the given arguments\nand with `paramset_name`/`paramset` attached to its scores.\nIf not provided, the parameter sets default to the `info.variants`\ndefined in the method components' configs. A method without\n`info.variants` is run once with its default parameter set.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
          "direction" : "input",
        ...
        },
        {
          ...
          "description" : "A list of method ids to include. If specified, only these methods will be run.\nFor parameterised methods, a single paramset can be targeted as `<method_id>.<paramset_name>`, e.g. `scprint.large`.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "A list of method ids to exclude. If specified, all methods except the ones listed will be run.\nFor parameterised methods, a single paramset can be excluded as `<method_id>.<paramset_name>`, e.g. `scprint.large`.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
